...
function setup(){
  ...
  // hidden p5.play sprite so the project uses p5.play
  playerSprite = new Sprite(-100, -100, playerSize, playerSize);
...
function draw(){
  ...
  // sync hidden p5.play sprite to your real player
  ...
  // win condition: collect 10 good foods
...
function drawUI(){
  ...
  fill(0);
  textAlign(LEFT);
  text("Height: " + floor(score), 20, 90);

  // fruit counter on top right
  textAlign(RIGHT);
  text("Fruit: " + foodsCollected + "/10", width - 20, 30);
}
...
function showWinScreen(){
  ...
  textSize(20);
  text("You collected 10 fruits!", width/2, 160);
